...
SAMPLE · Close +1M edition · Tuesday, Sep 8 · as of 1:03 PM PT
...
- **WATCH · Into the next session** — Revisit the gold fund and miners on the same return horizon. Check: Miners join the metal fund&#x27;s strength. If not: Miner weakness persists despite firmness in the gold fund. [evidence](#evidence-GLD-daily) [evidence](#evidence-GDX-daily) [evidence](#evidence-GDX-spread20)
...
| Symbol | Change | 20D | vs QQQ · 20s | vs 50DMA |
|---|---:|---:|---:|---:|
| NVDA | n/a | +9.44 % | +6.39 pp | +11.82 % |
...
| Sector | vs SPY · 20s | 20D | Change | vs 50DMA |
|---|---:|---:|---:|---:|
| Industrials (XLI) | -0.18 pp | +1.00 % | n/a | +1.00 % |

## Cross-asset structure

| Instrument | Change | 20D | vs benchmark · 20s | vs 50DMA |
|---|---:|---:|---:|---:|
| Gold fund (GLD) | n/a | +2.32 % | n/a vs benchmark | +2.85 % |
| Gold miners (GDX) | n/a | -0.81 % | -3.13 pp vs GLD | -0.99 % |

## Sources & coverage

Basis: Close +1M · prior close · Treasury prior-close/current as available · current prints available · breadth available
...
**SPY-intraday** · SPY · -0.53 % · latest trade versus previous regular close · observed/published 2026-09-08T19:59:00+00:00 · source sample-prices
